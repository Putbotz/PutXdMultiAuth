...
let handler = async (m, { conn, args, usedPrefix }) => {
    ...
    if (!args[0]) return conn.reply(m.chat,  `.ktp 6283893476233|Elisabeth|Jakarta, 02-07-2023|Perempuan|Jepang|02/02|Suka makmur|Suka Maju|Islam|Belum Kawin|Mahasiswa|Indonesia|Seumur Hidup|Suka Mundur|Sukasuka`, m)
